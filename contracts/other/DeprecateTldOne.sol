...
// this contract burns one domain and mints one new domain
contract DeprecateTldOne is Ownable, ReentrancyGuard {
  ...
  function refund(
    ...
    require(_msgSender() == tldContract.getDomainHolder(_oldDomainName), "DeprecateTldOne: Sender is not domain holder.");

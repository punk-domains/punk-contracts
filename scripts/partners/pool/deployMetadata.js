// npx hardhat run scripts/partners/pool/deployMetadata.js --network optimisticEthereum
// add metadata address to:
// 1) TLD contract as metadata

async function main() {
  const contractName = "PoolMetadata";
